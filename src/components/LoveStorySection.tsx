...
const milestones = [
  {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-12 h-12">
        <circle cx="22" cy="30" r="14" fill="none" stroke="hsl(350, 40%, 65%)" strokeWidth="2.5" />
        <circle cx="38" cy="30" r="14" fill="none" stroke="hsl(38, 50%, 80%)" strokeWidth="2.5" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-12 h-12">
        ...
        <circle cx="30" cy="20" r="4" fill="hsl(350, 40%, 65%)" opacity="0.8" />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-12 h-12">
        <path d="M18 42 L22 22 Q30 14 38 22 L42 42" fill="none" stroke="hsl(350, 40%, 65%)" strokeWidth="2" />
        <path d="M22 22 Q30 18 38 22" fill="none" stroke="hsl(145, 20%, 60%)" strokeWidth="1.5" />
        <circle cx="26" cy="38" r="2" fill="hsl(38, 50%, 80%)" />
        <circle cx="34" cy="38" r="2" fill="hsl(38, 50%, 80%)" />
        <line x1="26" y1="36" x2="26" y2="28" stroke="hsl(145, 20%, 60%)" strokeWidth="1" />
        <line x1="34" y1="36" x2="34" y2="28" stroke="hsl(145, 20%, 60%)" strokeWidth="1" />
      </svg>
    ),
  },
];
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-cream/50 to-blush/20 relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <p className="text-center font-body text-muted-foreground mb-16">A journey written in the stars</p>

        {/* Timeline */}
        <div className="relative">
          {/* Vine line */}
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-sage via-rose to-champagne md:-translate-x-px" />
            ...
            >
              ...
              >
                <div className="bg-card/70 backdrop-blur-sm rounded-2xl p-6 border border-border shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  {milestone.image && (
                    <div className="mt-4 rounded-xl overflow-hidden border-2 border-champagne/50">
                      <img
                        src={milestone.image}
      ...
      <div className="absolute top-20 right-0 opacity-10 animate-float-gentle">
        <svg width="120" height="120" viewBox="0 0 120 120">
          <ellipse cx="60" cy="60" rx="40" ry="20" fill="hsl(145, 25%, 55%)" transform="rotate(30, 60, 60)" />
          <ellipse cx="60" cy="60" rx="35" ry="15" fill="hsl(145, 25%, 55%)" transform="rotate(-20, 60, 60)" />
        </svg>
      </div>
    </section>
  );
